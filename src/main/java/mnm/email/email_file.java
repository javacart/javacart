...
public class email_file {
    public String gettext(String file,String name){
...
"                        <h3>فایل جدید به پنل اضافه شد:</h3>\n" +
"                        <br>\n" +
"                      </td>\n" +
"                    </tr>\n" +
"                  </table>\n" +
...
"                   <a href=\""+file+"\"><span style=\"font-family: Courier;\">"+name+"</span></a>\n" +
"                      </td>\n" +
"                    </tr>\n" +
"                  </table>\n" +
"                  </center>\n" +
...
"                      <br>\n" +
"                        امیدواریم از سرویس های خود در پرداخت برای خرید خرسند باشید.\n" +
"                      <br>\n" +
"                      <br>\n" +
"\n" +
"                      </td>\n" +

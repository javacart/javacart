 ...
 */
public class email_welcome {
    
    public String getTxt(String name,String pass){
...
"                        <h3>به پرداخت برای خرید خوش آمدید.</h3>\n" +
"                        <br>\n" +
"                      </td>\n" +
"                    </tr>\n" +
"                  </table>\n" +
...
"                   ایمیل شما: <span style=\"font-family: Courier;\">"+name+"</span>\n" +
            "                   گذرواژه شما: <span style=\"font-family: Courier;\">"+pass+"</span>\n" +
"                      </td>\n" +
"                    </tr>\n" +
"                  </table>\n" +
"                  </center>\n" +
...
"                      <br>\n" +
"                        بسیار خرسندیم که به جمع کاربران پرداخت برای خرید پیوسته اید.\n" +
"                          از اینکه در این سامانه به شما خدمت گذاری می کنیم بسیار خوشحالیم.\n" +
"                      <br>\n" +
"                      <br>\n" +
"\n" +
"                      </td>\n" +
